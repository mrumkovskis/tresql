...
class Functions {
  ...
  def mkString(res: DynamicSelectResult): String = mkString(res, ";")
  def mkString(res: DynamicSelectResult, colSep: String): String = mkString(res, colSep, "\n")
  def mkString(res: DynamicSelectResult, colSep: String, rowSep: String) = {
