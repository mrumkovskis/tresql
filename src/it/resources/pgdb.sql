...
// 
DROP TABLE IF EXISTS ABSTIME_TBL;
//
...
DROP TABLE IF EXISTS DUMMY, SALGRADE, TYRES_USAGE, TYRES, CAR_IMAGE, CAR_USAGE, CAR, DEPT_EQUIPMENT, ADDRESS, DEPT_SUB_ADDR, DEPT_ADDR, EMP, DEPT, WORK;
//
CREATE TABLE WORK
